...
local groups = {
  ...
  { 'TelescopePromptBorder', { bg = palette.bg_float,  fg = palette.border_highlight } },
  { 'TelescopePromptNormal', { bg = palette.bg_float,  fg = palette.orange } },
  { 'TelescopeResultsBorder',{ bg = palette.bg_float,  fg = palette.fg_float } },
  { 'TelescopePreviewBorder',{ bg = palette.bg_float,  fg = palette.fg_float } },
